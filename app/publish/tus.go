...
const module = "tus.publish"

// PublishHandler handle media publishing on odysee-api, it implements TUS
...
func NewHandler(authProvider auth.Provider, cfg tusd.Config, uploadPath string) (*PublishHandler, error) {
	h := &PublishHandler{}
	...
	// make sure target directory is exist
...
func (h PublishHandler) Notify(w http.ResponseWriter, r *http.Request) {
...
func (h PublishHandler) lockUpload(id string) (tusd.Lock, error) {
